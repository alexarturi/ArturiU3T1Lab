public class CatHouseRunner {
    public static void main(String[] args) {
        ...
        Cat mouse = new Cat("Mouse", 10);
        CatHouse test = new CatHouse(charlie, mouse, "Alex");
        System.out.println(test.houseInfo());
        test.rollCall();
        ...
        Cat alpha = new Cat("Alpha", 4);
        Cat beta = new Cat("Beta", 4);
        CatHouse house = new CatHouse(alpha, beta, "Alex");
